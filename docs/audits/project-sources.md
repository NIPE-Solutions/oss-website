...
Observed on **2026-09-04** in Europe/Vienna. This inventory records the public evidence available for the first NIPE Open Source directory release. GitHub state was queried with `gh api`; npm publication state was queried with `npm view`. Local sibling checkouts were treated as read-only hints only, because several were behind their remotes.
...
| React Swipe Actions         | Omit                           | No meaningfully usable public implementation  | None under the NIPE scope                          |
| Angular Flex-Layout Codemod | Include under Tooling          | Prerelease / beta                             | `@nipe-solutions/flex-layout-codemod@2.0.0-beta.1` |
...
- Default branch evidence: `main` at [`3d6e9409aad5feb0dc28830f1521ddd121207567`](https://github.com/NIPE-Solutions/react-spring-bottom-sheet/commit/3d6e9409aad5feb0dc28830f1521ddd121207567).
...
- Primary sources inspected: released [README](https://github.com/NIPE-Solutions/react-spring-bottom-sheet/blob/v5.0.1/README.md), [changelog](https://github.com/NIPE-Solutions/react-spring-bottom-sheet/blob/v5.0.1/CHANGELOG.md), [v4-to-v5 migration guide](https://github.com/NIPE-Solutions/react-spring-bottom-sheet/blob/v5.0.1/docs/migration-v4-to-v5.md), default-branch [contribution guide](https://github.com/NIPE-Solutions/react-spring-bottom-sheet/blob/3d6e9409aad5feb0dc28830f1521ddd121207567/CONTRIBUTING.md), live documentation, GitHub release, and npm metadata.
- Security/contribution state: no root `SECURITY.md` was present and GitHub private vulnerability reporting was disabled when queried. The default-branch contribution guide still discusses the older v4/v5 planning split and some obsolete script names, so it is not a source for current public API claims.
...
- Default branch evidence: `main` at [`5941a8b8f0e76b1e5bac6188a0d00fbf1d71556c`](https://github.com/NIPE-Solutions/readonly-view/commit/5941a8b8f0e76b1e5bac6188a0d00fbf1d71556c).
- Released evidence: tag [`v2.0.1`](https://github.com/NIPE-Solutions/readonly-view/releases/tag/v2.0.1) points to the same commit and was published 2026-09-04.
...
- Primary sources inspected: released [README](https://github.com/NIPE-Solutions/readonly-view/blob/v2.0.1/README.md), [API reference](https://github.com/NIPE-Solutions/readonly-view/blob/v2.0.1/docs/api.md), [guarantees](https://github.com/NIPE-Solutions/readonly-view/blob/v2.0.1/docs/guarantees.md), [supported types](https://github.com/NIPE-Solutions/readonly-view/blob/v2.0.1/docs/supported-types.md), [changelog](https://github.com/NIPE-Solutions/readonly-view/blob/v2.0.1/CHANGELOG.md), default-branch [security policy](https://github.com/NIPE-Solutions/readonly-view/blob/5941a8b8f0e76b1e5bac6188a0d00fbf1d71556c/SECURITY.md) and [contribution guide](https://github.com/NIPE-Solutions/readonly-view/blob/5941a8b8f0e76b1e5bac6188a0d00fbf1d71556c/CONTRIBUTING.md), live documentation, GitHub release, and npm metadata.
- Security state: `SECURITY.md` tells reporters to use GitHub private vulnerability reporting, but the GitHub API reported that private vulnerability reporting was disabled. Until reconciled, the directory should link to the policy without claiming the private route is operational.
...
- GitHub state: public, unarchived, default branch named `main`, repository size `0`, with no commit reachable through the commits API, no tree, no README, no package metadata, no license, no tags, and no releases when observed.
- npm state: `npm view @nipe-solutions/react-swipe-actions` returned `E404`. The unscoped `react-swipe-actions@1.0.2` belongs to `kwelch/react-swipe-actions`, not NIPE, and must not be attributed to NIPE.
...
- Decision: no public directory entry. Re-audit after an implementation, license, README, release, and intended package identity exist publicly.
...
- Default branch evidence: `main` at [`ac30340cdbfb31547abeced8825d11aef8adf9a1`](https://github.com/NIPE-Solutions/flex-layout-migrator/commit/ac30340cdbfb31547abeced8825d11aef8adf9a1).
...
- Primary sources inspected: released [README](https://github.com/NIPE-Solutions/flex-layout-migrator/blob/v2.0.0-beta.1/README.md), [compatibility reference](https://github.com/NIPE-Solutions/flex-layout-migrator/blob/v2.0.0-beta.1/docs/compatibility.md), [changelog](https://github.com/NIPE-Solutions/flex-layout-migrator/blob/v2.0.0-beta.1/CHANGELOG.md), released package metadata, default-branch [security policy](https://github.com/NIPE-Solutions/flex-layout-migrator/blob/ac30340cdbfb31547abeced8825d11aef8adf9a1/SECURITY.md) and [contribution guide](https://github.com/NIPE-Solutions/flex-layout-migrator/blob/ac30340cdbfb31547abeced8825d11aef8adf9a1/CONTRIBUTING.md), GitHub prerelease, and npm metadata.
- Security state: GitHub private vulnerability reporting was enabled and is the documented security route.
...
The current live [Impressum](https://react-spring-bottom-sheet.nipesolutions.com/impressum/) and [Privacy page](https://react-spring-bottom-sheet.nipesolutions.com/privacy/) were re-checked on 2026-09-04. Their source values are also visible in [`website/content/legal.ts`](https://github.com/NIPE-Solutions/react-spring-bottom-sheet/blob/3d6e9409aad5feb0dc28830f1521ddd121207567/website/content/legal.ts).
