...
## Ecosystem expansion verification — 2026-09-05

The seven-project registry expansion was checked against fixed repository evidence and live package/documentation observations on 2026-09-05. Repository commit pins remain the evidence boundary even when a repository has advanced since the audit.

| Project                     | Audited repository commit                                                                                                                                 | npm observation                                                       | Documentation observation                                                                                                                                                                                                                                                                   |
| --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| React Spring Bottom Sheet   | [`465d32fe2caf52f4d708e3a81d8fdff04350bfbe`](https://github.com/NIPE-Solutions/react-spring-bottom-sheet/commit/465d32fe2caf52f4d708e3a81d8fdff04350bfbe) | `@nipe-solutions/react-spring-bottom-sheet@5.0.1` resolved from npm   | <https://react-spring-bottom-sheet.nipesolutions.com> returned HTTP `200`                                                                                                                                                                                                                   |
| Readonly View               | [`8ab6b2d6031209926d49830d251b2b630608c2f7`](https://github.com/NIPE-Solutions/readonly-view/commit/8ab6b2d6031209926d49830d251b2b630608c2f7)             | `@nipe-solutions/readonly-view@2.0.1` resolved from npm               | <https://readonly-view.nipesolutions.com> returned HTTP `200`                                                                                                                                                                                                                               |
| Angular Flex-Layout Codemod | [`72a4960a738ba4f059afb28c9f1a0b30d827572b`](https://github.com/NIPE-Solutions/flex-layout-migrator/commit/72a4960a738ba4f059afb28c9f1a0b30d827572b)      | `@nipe-solutions/flex-layout-codemod@2.0.0-beta.1` resolved from npm  | The released [`v2.0.0-beta.1` README](https://github.com/NIPE-Solutions/flex-layout-migrator/blob/v2.0.0-beta.1/README.md) returned HTTP `200`                                                                                                                                              |
| React Swipe Actions         | [`1c798c20878165cb2a3702ea18f4967834551b63`](https://github.com/NIPE-Solutions/react-swipe-actions/commit/1c798c20878165cb2a3702ea18f4967834551b63)       | `@nipe-solutions/react-swipe-actions@0.1.0-alpha.0` resolved from npm | <https://react-swipe-actions.nipesolutions.com> returned HTTP `200`                                                                                                                                                                                                                         |
| React Anchored Layer        | [`93c83bd2cd569bfdc2c5bd128f1f3add39ae7696`](https://github.com/NIPE-Solutions/react-anchored-layer/commit/93c83bd2cd569bfdc2c5bd128f1f3add39ae7696)      | `@nipe-solutions/react-anchored-layer` returned npm `E404`            | <https://react-anchored-layer.nipesolutions.com> returned HTTP `200`                                                                                                                                                                                                                        |
| React Pull to Refresh       | [`3e7b232a23b59e7e44ca0a6b8a13d3d02f839b18`](https://github.com/NIPE-Solutions/react-pull-to-refresh/commit/3e7b232a23b59e7e44ca0a6b8a13d3d02f839b18)     | `@nipe-solutions/react-pull-to-refresh` returned npm `E404`           | <https://react-pull-to-refresh.nipesolutions.com> returned HTTP `200`                                                                                                                                                                                                                       |
| React Viewport              | [`08a4b3a2353d934835eb1054dd6ddadef2370e65`](https://github.com/NIPE-Solutions/react-viewport/commit/08a4b3a2353d934835eb1054dd6ddadef2370e65)            | `@nipe-solutions/react-viewport` returned npm `E404`                  | The intended `react-viewport.nipesolutions.com` hostname did not resolve; the [commit-pinned repository README](https://github.com/NIPE-Solutions/react-viewport/blob/08a4b3a2353d934835eb1054dd6ddadef2370e65/README.md) returned HTTP `200` and is the registry documentation destination |

An npm `E404` sets `npm.published` to `false` and suppresses npm/install actions. A package name or version in repository `package.json` records release intent only; it is not converted into a publication claim without a successful npm registry result. This applies explicitly to React Anchored Layer, React Pull to Refresh, and React Viewport. React Swipe Actions is the only published npm package among the four Alpha projects in this audit.
